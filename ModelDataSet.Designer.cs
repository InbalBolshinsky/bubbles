...
namespace funkyBubbles.ModelDataSetTableAdapters {
    ...
    public partial class scoringTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[scoring] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 A" +
                "ND [name] IS NULL) OR ([name] = @Original_name)) AND ([score] = @Original_score)" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[scoring] ([Id], [name], [score], [status]) VALUES (@Id, @name," +
                " @score, @status);\r\nSELECT Id, name, score, status FROM scoring WHERE (Id = @Id)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[scoring] SET [Id] = @Id, [name] = @name, [score] = @score, [status] = @status WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ([score] = @Original_score) AND ([status] = @Original_status));
SELECT Id, name, score, status FROM scoring WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::funkyBubbles.Properties.Settings.Default.connection;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, score, status FROM dbo.scoring";
        ...
        public virtual int Fill(ModelDataSet.scoringDataTable dataTable) {
        ...
        public virtual ModelDataSet.scoringDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ModelDataSet.scoringDataTable dataTable = new ModelDataSet.scoringDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ModelDataSet.scoringDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_score, string Original_status) {
        ...
        public virtual int Insert(int Id, string name, string score, string status) {
        ...
        public virtual int Update(int Id, string name, string score, string status, int Original_Id, string Original_name, string Original_score, string Original_status) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string score, string status, int Original_Id, string Original_name, string Original_score, string Original_status) {
            return this.Update(Original_Id, name, score, status, Original_Id, Original_name, Original_score, Original_status);
        }
    }
