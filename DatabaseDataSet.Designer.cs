...
namespace funkyBubbles {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class scoringDataTable : global::System.Data.TypedTableBase<scoringRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public scoringRow AddscoringRow(int score, string name, string status) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public scoringRow FindByscore(int score) {
        ...
        public partial class scoringRow : global::System.Data.DataRow {
            ...
            public int score {
                get {
                    return ((int)(this[this.tablescoring.scoreColumn]));
                }
                set {
            ...
            public string status {
                get {
                    return ((string)(this[this.tablescoring.statusColumn]));
                }
                set {
                    this[this.tablescoring.statusColumn] = value;
                }
            }
...
namespace funkyBubbles.DatabaseDataSetTableAdapters {
    ...
    public partial class scoringTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[scoring] WHERE (([score] = @Original_score) AND ((@IsNull_name" +
                " = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ([status] = @Original" +
                "_status))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[scoring] ([score], [name], [status]) VALUES (@score, @name, @s" +
                "tatus);\r\nSELECT score, name, status FROM scoring WHERE (score = @score)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[scoring] SET [score] = @score, [name] = @name, [status] = @status WHERE (([score] = @Original_score) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ([status] = @Original_status));
SELECT score, name, status FROM scoring WHERE (score = @score)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::funkyBubbles.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT score, name, status FROM dbo.scoring";
        ...
        public virtual int Fill(DatabaseDataSet.scoringDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.scoringDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.scoringDataTable dataTable = new DatabaseDataSet.scoringDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.scoringDataTable dataTable) {
        ...
        public virtual int Delete(int Original_score, string Original_name, string Original_status) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_score));
        ...
        public virtual int Insert(int score, string name, string status) {
        ...
        public virtual int Update(int score, string name, string status, int Original_score, string Original_name, string Original_status) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string status, int Original_score, string Original_name, string Original_status) {
            return this.Update(Original_score, name, status, Original_score, Original_name, Original_status);
        }
    }
        ...
        public virtual int UpdateAll(DatabaseDataSet dataSet) {
            ...
            try {
                ...
                if ((this._scoringTableAdapter != null)) {
                    ...
                    this._scoringTableAdapter.Connection = ((global::System.Data.SqlClient.SqlConnection)(workConnection));
                    this._scoringTableAdapter.Transaction = ((global::System.Data.SqlClient.SqlTransaction)(workTransaction));
                ...
                if ((this._scoringTableAdapter != null)) {
                    this._scoringTableAdapter.Connection = ((global::System.Data.SqlClient.SqlConnection)(revertConnections[this._scoringTableAdapter]));
